"""
Django settings for sisautoeval project.
...
SECRET_KEY = 'yem6_%*vcld7kf-v)a%j&6u9gpoi7_za#rb+*en9jq!4g4!ex#'
...
WSGI_APPLICATION = 'sisautoeval.wsgi.application'
